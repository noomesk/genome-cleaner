...
def main():
    ...
    with st.sidebar:
        st.markdown("### Genome Cleaner")
        st.markdown("---")
        
        uploaded_file = st.file_uploader(
            "Upload Sequence File",
            type=['fasta', 'fa', 'fastq', 'fq'],
            help="Supported formats: FASTA, FASTQ"
        )
        ...
        min_length = st.slider(
            ...
            max_value=200,
            value=20,
            help="Sequences shorter than this will be flagged"
        )
        
        sanitize_mode = st.checkbox(
            "Sanitization Mode",
            value=False,
            help="Automatically replace invalid characters with 'N'"
        )
            ...
            if process_btn:
                try:
                    ...
                    with st.spinner("Processing sequences..."):
                        sequences = load_sequences(str(file_path))
                        results = validate_sequences(sequences, min_length, sanitize_mode)
    ...
    <div class="hero-wrapper">
        ...
        <div class="hero-container">
            ...
            <p class="hero-subtitle">
                Professional-grade sequence validation and cleaning for modern bioinformatics. 
                Fast, secure, and reproducible.
            </p>
            ...
            <div class="feature-grid">
                <div class="feature-card">
                    ...
                    <div class="feature-desc">
                        Optimized parsing engine capable of handling large FASTA/FASTQ datasets in seconds.
                    </div>
                </div>
                ...
                <div class="feature-card">
                    ...
                    <div class="feature-desc">
                        Automatic detection of format errors, duplicates, and low-complexity sequences.
                    </div>
                </div>
                ...
                <div class="feature-card">
                    ...
                    <div class="feature-desc">
                        Interactive Plotly charts for quality distribution and GC content analysis.
                    </div>
                </div>
                
                <div class="feature-card">
                    <div class="feature-title">Auto-Sanitization</div>
                    <div class="feature-desc">
                        Intelligent cleaning algorithms to standardize your data for downstream analysis.
                    </div>
                </div>
            </div>
